            ...
            <div class="col-lg-8">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post-thumb">
                            <img src="{{ $first_post->featured }}" alt="{{ $first_post->title }}" style="width:100%">
        ...
        <div class="row">
            <div class="col-lg-6">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post-thumb">
                            <img src="{{ $second_post->featured }}" alt="{{ $second_post->title }}" width="100%">
                            <div class="overlay"></div>
            ...
            <div class="col-lg-6">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post-thumb">
                            <img src="{{ $third_post->featured }}" alt="{{ $third_post->title }}" width="100%">
                            <div class="overlay"></div>
            ...
            <div class="container">
                ...
                <div class="offers">
                    <div class="row">
                        <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                            <div class="heading">
                                <a href="{{ route('category.single', ['id' => $jquery->id])}}"><h4 class="h1 heading-title">{{ $jquery->name}}</h4></a>
                ...
                <div class="offers">
                    <div class="row">
                        <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                            <div class="heading">
                                <a href="{{ route('category.single', ['id' => $javascript->id])}}"><h4 class="h1 heading-title">{{ $javascript->name }}</a></h4>
                                <div class="heading-line">
                                    <span class="short-line"></span>
                                    <span class="long-line"></span>
                                </div>
                ...
                <div class="offers">
                    <div class="row">
                        <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                            <div class="heading">
                                <a href="{{ route('category.single', ['id' => $laravel->id])}}"><h4 class="h1 heading-title">{{ $laravel->name }}</h4></a>
                                <div class="heading-line">
                                    <span class="short-line"></span>
                                    <span class="long-line"></span>
                                </div>
